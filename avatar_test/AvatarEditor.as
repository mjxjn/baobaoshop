package 
{
    ...
    public class AvatarEditor extends Sprite
    {
        ...
        private function onBigSnap(event:Event) : void
        {
        ...
        private function editSmall(event:Event) : void
        {
        ...
        private function editPhoto() : void
        {
            ...
            this.bigEditWin.edit(this.editData, 382, 382);
        ...
        private function onCameraSnapSaved(event:Event) : void
        {
            this.photoServer = (event.target as BinaryTransfer).pServer;
            this.photoId = (event.target as BinaryTransfer).photoId;
            this.saveBig();
            return;
        }// end function
        ...
        private function onBigSaved(event:Event) : void
        {
            this.photoServer = (event.target as BinaryTransfer).pServer;
            this.saveSmall();
            return;
        ...
        {
            var _loc_2:* = (event.target as BinaryTransfer).msg;
            this.reEdit(null);
            ExternalInterface.call("avatarError", _loc_2);
            return;
        }// end function

        private function backToCamera(event:MouseEvent) : void
        {
            this.cameraView();
            return;
        }// end function
        ...
        private function editBig(event:Event) : void
        {
        ...
        private function initUI() : void
        {
            ...
            this.largeThumb = new PhotoThumb(382, 382, "宝宝的大头像(将显示在宝宝秀主页)");
            this.smallThumb = new PhotoThumb(48, 48, "宝宝的小头像");
            ...
            this.bigThumbButton = new ThumbButton(382, 382, "大头像预览");
            this.bigThumbButton.drawData(new BitmapData(382, 382, false, 13421772));
        ...
        private function noCamera(event:Event) : void
        {
        ...
        private function snappCamera(event:MouseEvent) : void
        {
        ...
        private function createEditWin() : void
        {
            ...
            this.bigEditWin = new EditWindow(null, 280, 330, 382, 382);
