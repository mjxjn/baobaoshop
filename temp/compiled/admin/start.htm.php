...
<!-- start today order statistics -->
<div class="list-div">
<table cellspacing='1' cellpadding='3'>
  <tr>
    <th colspan="4" class="group-title"><?php echo $this->_var['lang']['today_order']; ?></th>
  </tr>
  <tr>
    <td width="20%"><a href=""><?php echo $this->_var['lang']['today_pay']; ?></a></td>
    <td width="30%"><strong style="color: red"><?php echo $this->_var['order']['today_pay']; ?></strong></td>
    <td width="20%"><a href=""><?php echo $this->_var['lang']['today_confirmation']; ?></a></td>
    <td width="30%"><strong><?php echo $this->_var['order']['today_confirmation']; ?></strong></td>
  </tr>
  <tr>
    <td width="20%"><a href=""><?php echo $this->_var['lang']['today_cancel']; ?></a></td>
    <td width="30%"><strong style="color: red"><?php echo $this->_var['order']['today_cancel']; ?></strong></td>
    <td width="20%"><a href=""><?php echo $this->_var['lang']['today_unconfirmation']; ?></a></td>
    <td width="30%"><strong><?php echo $this->_var['order']['today_unconfirmation']; ?></strong></td>
  </tr>
    <tr>
    <td width="20%"><a href=""><?php echo $this->_var['lang']['today_money']; ?></a></td>
    <td width="30%"><strong><?php echo $this->_var['order']['today_money']; ?></strong></td>
    <td width="20%"><a href=""><?php echo $this->_var['lang']['today_member']; ?></a></td>
    <td width="30%"><strong><?php echo $this->_var['order']['today_member']; ?></strong></td>
  </tr>
  <tr>
    <td width="20%"><a href=""><?php echo $this->_var['lang']['today_vm']; ?></a></td>
    <td width="30%"><strong><?php echo $this->_var['order']['today_vm']; ?></strong></td>
    <td width="20%"></td>
    <td width="30%"></td>
  </tr>
</table>
</div>
<!-- end today order statistics -->
