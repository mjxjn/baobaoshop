...
<div id="head">
	<div id="logo_head" class="w980">
    	...
    	<?php $_from = $this->_var['ad_logo_i']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'ad');$this->_foreach['ad'] = array('total' => count($_from), 'iteration' => 0);
...
?>
		<?php if ($this->_foreach['ad']['iteration'] == 1): ?>
			<a href="<?php echo $this->_var['ad']['url']; ?>"><img src='<?php echo $this->_var['ad']['content']; ?>' width="160" height="60" /></a>
		<?php endif; ?>
