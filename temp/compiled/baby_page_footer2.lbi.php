...
<div
	style="height: 1px; background-color: #eee; width: 100%; margin: 0px 0 20px;"></div>
<div id="fd_Foot">
...
<div class="fArt fArt_f">
<div class="AdvBanner"><a target="_blank" href=""> <img
	style="" src="/themes/yingge/images/foot_logo.gif"> </a></div>
</div>

 <?php if ($this->_var['helps']): ?> <?php $_from = $this->_var['helps']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'help_cat');if (count($_from)):
    foreach ($_from AS $this->_var['help_cat']):
?>
<div class="fArt">
<div class="TreeList">
<div class="cat1 catfirst"><?php echo $this->_var['help_cat']['cat_name']; ?></div>
<?php $_from = $this->_var['help_cat']['article']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item_0_81421800_1376356158');if (count($_from)):
    foreach ($_from AS $this->_var['item_0_81421800_1376356158']):
?>
<div class="cat2">&middot;<a href="/<?php echo $this->_var['item_0_81421800_1376356158']['url']; ?>"><?php echo $this->_var['item_0_81421800_1376356158']['short_title']; ?></a></div>
...
?>
			<td><a href="<?php echo $this->_var['link']['url']; ?>" target="_blank" title="<?php echo $this->_var['link']['name']; ?>"><?php echo $this->_var['link']['name']; ?></a>
			</td>
...
<table cellspacing="0" cellpadding="0" border="0" align="right"
	...
	<tbody>
		<tr>
			...
			<p>关注婴格: <a target="_blank" type="url"
				href="http://weibo.com/yinggebaby" title="新浪微博">新浪微博</a> <a
				target="_blank" type="url" href="http://t.qq.com/helloyinggebaby"
				title="腾讯微博">腾讯微博</a></p>
			...
			<?php echo $this->_var['icp_number']; ?> <script
				src="http://s13.cnzz.com/stat.php?id=3791333&web_id=3791333"
...
<center><img src="/qualification/baojing.png"> <img
	src="/qualification/yingyezhizhao.png"> <img
	src="/qualification/xiehui.png"> <img
	src="/qualification/360anquan.png"></center>
