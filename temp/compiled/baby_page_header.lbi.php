...
?>
            <li class="menu_h"><a href="<?php if ($this->_var['nav']['url'] != 'http://bbs.3330777.com/'): ?>/<?php echo $this->_var['nav']['url']; ?><?php else: ?><?php echo $this->_var['nav']['url']; ?><?php endif; ?>" <?php if ($this->_var['nav']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav']['name']; ?></a></li>
			<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </ul>
    </div>
</div>