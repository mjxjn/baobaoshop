...
assign_template();
assign_dynamic('onlintree');
$position = assign_ur_here(0, $_LANG['shopping_onlinetree']);
...
/*
$sql = "SELECT * FROM " . $ecs->table('goods'). " where is_promote=1 and is_delete=0 ORDER BY `is_best` DESC,`goods_id` DESC";
$res = $db->query($sql);
