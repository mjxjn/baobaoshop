...
$modules['02_cat_and_goods']['18_batch_excel']        = 'goods_batch.php?act=excel';    // 商品批量更新
$modules['02_cat_and_goods']['18_batch_upgoods']        = 'goods_batch.php?act=upgoods_excel';    // 商品批量上传
...
$modules['03_promotion']['16_double_integral']       = 'double_integral.php?act=list';
...
//$modules['13_backup']['05_synchronous']             = 'excel.php?act=sync';
//$modules['13_backup']['05_synchronous']             = 'integrate.php?act=sync';
$modules['13_backup']['convert']                    = 'convert.php?act=main';


$modules['14_sms']['05_sms_my_info']                = 'sms.php?act=display_my_info';
$modules['14_sms']['03_sms_content']                = 'sms.php?act=display_charge_ui';
$modules['14_sms']['04_sms_send']                   = 'sms.php?act=display_send_ui';
...
$modules['17_baby']['baby_list']                    = 'baby.php?act=list';
$modules['17_baby']['baby_comment']                 = 'baby_comment.php?act=list';
$modules['17_baby']['baby_ia']                      = 'baby_ia.php?act=list';

$modules['18_index']['01_affordable']                    = 'affordable.php?act=list';
$modules['18_index']['02_food']                     = 'setindex.php?act=food';
$modules['18_index']['03_supplies']                      = 'setindex.php?act=supplies';
$modules['18_index']['04_entertainment']                      = 'setindex.php?act=entertainment';
$modules['18_index']['05_clothing']                      = 'setindex.php?act=clothing';
$modules['18_index']['06_learning']                      = 'setindex.php?act=learning';
$modules['18_index']['07_mother']                      = 'setindex.php?act=mother';
$modules['18_index']['08_promotion']                      = 'setindex.php?act=promotion';
