...
function orderShippingSelectedResponse(result)
{
  ...
  try
  {
    if (document.getElementById('new_payment_editbox') != undefined)
    {
      document.getElementById('new_payment_editbox').innerHTML = result.pay_info;
    }
  }
  catch (ex)
  {
...
function changeBonus(val)
{
  ...
  Ajax.call('source/ajax.php?step=change_bonus', 'bonus=' + val, changeBonusResponse, 'GET', 'JSON');
}
...
{
  Ajax.call('source/ajax.php?step=validate_bonus', 'bonus_sn=' + bonusSn, validateBonusResponse, 'GET', 'JSON');
}
