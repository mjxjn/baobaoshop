...
elseif ($_REQUEST['step'] == 'update_cart')
{
    ...
    {
        flow_update_cart($_POST['rec_key']);
    }
...
$smarty->assign('hot_goods',       get_category_recommend_goods('hot', $children, $brand, $price_min, $price_max, $ext, '12'));
...
function flow_update_cart($key)
{
	...
	$result['content']['tishi_delete_favor']='';
	$result['content']['have_gift_goods_key']='';
	
	$favourable_list=favourable_list($_SESSION['user_id']);
	$result['content']['cart_favor_area']=$_SESSION['user_id'];
	if(favourable_available($favourable_list['0']))
	{
		$result['content']['cart_favor_area']='';
		act_range_desc($favourable_list['0']);//string 优惠范围描述
		$cart_favourable=cart_favourable();//array优惠活动及数量
		
		if(!$cart_favourable)
		{
			$i=0;
			foreach ($favourable_list['0']['gift'] as $key => $value)
        	{
				if($i==0)
				{
				$favourable[$key]['formated_price'] = price_format($value['price'], false);
				$favourable[$key]['price'] =$value['price'];
				$favourable[$key]['goods_id'] = $value['id'];
				$favourable[$key]['name'] = $value['name'];
				$sql = "SELECT goods_thumb FROM " . $GLOBALS['ecs']->table('goods') . " WHERE is_on_sale = 1 AND goods_id = ".$value['id'];
            	$favourable[$key]['goods_thumb'] = $GLOBALS['db']->getOne($sql);
				
				add_gift_to_cart($favourable_list['0']['act_id'], $favourable[$key]['goods_id'], $favourable[$key]['price']);
			
				$result['content']['cart_favor_area']="<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" id=\"goods_".$favourable[$key]['goods_id']."_0_".$favourable_list['0']['act_id']."_0\">
			  <tbody><tr>
							<td class=\"cb_r11 zp_td\"><a href=\"goods.php?id=".$favourable[$key]['goods_id']."\" target=\"_blank\"><img src=\"".$favourable[$key]['goods_thumb']."\" alt=\"".$favourable[$key]['name']."\" width=\"55\" height=\"55\"></a></td>
				<td class=\"cb_r12 zp_td\"><a href=\"goods.php?id=".$favourable[$key]['goods_id']."\" target=\"_blank\">".$favourable[$key]['name']."</a><br><span class=\"zp_intro\">赠品说明</span></td>
							<td align=\"center\" class=\"cb_r13 zp_td\"><span class=\"give_p\" title=\"赠品\">赠品</span></td>
				<td align=\"center\" class=\"cb_r2 zp_td\">
				免费            </td>
				<td align=\"center\" class=\"cb_r3 zp_td\">0</td>
				<td align=\"center\" class=\"cb_r4 zp_td\"><p class=\"num_line\">1                          </p></td>
				<td align=\"center\" class=\"cb_r5 zp_td\"><span><b>免费</b></span></td>
				<td align=\"center\" class=\"cb_r6 zp_td\"><span class=\"del_opt\" gift=\"\" rec_key=\"".$favourable[$key]['goods_id']."_0_".$favourable_list['0']['act_id']."_0\">删除</span></td>
			  </tr>
			  <tr class=\"zptip_td\">
				<td colspan=\"8\"><div class=\"zp_tip zp_tip1\">赠品说明：".$favourable_list['0']['act_name']."赠".$favourable[$key]['name']."<span class=\"tip_hide\"></span></div></td>
			  </tr>
			</tbody></table>";
				$i++;
				}
	...
	if ($_SESSION['user_id']!=0)
	{	
	$result['content']['bonus_list_area']="
	<dt style=\"display:none\" id=\"yhq_1\"> 
	<ul class=\"yhq_line\"> 
	<li><span class=\"yhq_lab\">使用已有优惠券:</span></li>";
	 if (empty($user_bonus))
	 {
	$result['content']['bonus_list_area'].="<li class=\"yhq_select yhq_inputbox\" style=\"padding-right:0;width:212px;\"><input class=\"yhq_input\" id=\"yhq_input\" name=\"\" type=\"text\" style=\"width:200px;cursor:pointer;\" value=\"您的账户中没有优惠券...\" readonly=readonly /> </li>";
	 }else{
		 $result['content']['bonus_list_area'].="<li class=\"yhq_select yhq_inputbox\" style=\"padding-right:0;width:190px;\"><select name=\"bonus\" onchange=\"changeBonus(this.value)\" id=\"ECS_BONUS\" style=\"border:1px solid #ccc;\">
                  <option value=\"0\">选择账户中的优惠券</option>";
		 foreach ($user_bonus AS $key => $val)
         {
	 		$result['content']['bonus_list_area'].="
                  <option value=\"".$val['bonus_id']."\" >".$val['type_name']."[".price_format($val['type_money'], false)."]</option>
                ";
		 }
		 $result['content']['bonus_list_area'].="</select></li>";
	 }
	$result['content']['bonus_list_area'].=" 
	<li><span class=\"yhq_lab\"><a class=\"blue yhq_js_change\" style=\"padding-left:10px;\">输入优惠券/兑换券代码>> </a></span></li> 
	<li id=\"yhq_tip_1\"></li> 
	</ul>
	<div class=\"clear\"></div> 
	</dt> 
	...
	<li class=\"yhq_select yhq_inputbox\" style=\"width:165px;\"><input id=\"bonus_sn\" class=\"yhq_input\" name=\"\" maxlength=\"25\" type=\"text\" /></li> 
	<li class=\"yhqyzm_box\" style=\"display:none;\"><span class=\"fl yzm_lab\">验证码:</span><img src=\"captcha.php?\" alt=\"看不清？请点击！\" id='captcha1' style=\"cursor: pointer;\" onClick=\"this.src='captcha.php?'+Math.random()\" /> <input class=\"fl yhq_yzm\" id=\"bonus_captcha\" type=\"text\" maxlength=\"6\" /><span class=\"fl yzm_lab\">看不清？<a style=\"cursor:pointer;\" onClick=\"$('#captcha1').click();\" class=\"blue\">换一张</a></span></li> 
	<li class=\"yhq_select\" id=\"use_quan\"><a onClick=\"addBonus($('#bonus_sn').val());\" class=\"cbtn use_btn\" >使用</a></li> 
	<li><span class=\"yhq_lab\"><a class=\"blue yhq_js_change\" style=\"padding-left:10px;\">使用已有优惠券>></a></span></li> 
	<li id=\"yhq_tip_2\"></li> 
	</ul>
	<div class=\"clear\"></div> 
	</dt>";
	...
	<ul class=\"yhq_line\"> 
	<li><span class=\"yhq_lab\">使用已有优惠券:</span></li> 
	<li class=\"yhq_select yhq_inputbox\" style=\"padding-right:0;width:212px;\"><input class=\"yhq_input\" id=\"yhq_input\" name=\"\" type=\"text\" style=\"width:200px;cursor:pointer;\" value=\"您的账户中没有优惠券...\" readonly=readonly /> </li> 
	<li class=\"yhq_select\"><span class=\"cbtn yhq_sbtn\">选择</span></li> 
	<li><span class=\"yhq_lab\"><a class=\"blue yhq_js_login\" style=\"padding-left:10px;\">输入优惠券/兑换券代码>> </a></span></li> 
	<li id=\"yhq_tip_1\"></li> 
	</ul>
	<div class=\"clear\"></div> 
	</dt> 
	...
	<li class=\"yhqyzm_box\" style=\"display:none;\"><span class=\"fl yzm_lab\">验证码:</span><img src=\"captcha.php?\" alt=\"看不清？请点击！\" id='captcha1' style=\"cursor: pointer;\" onClick=\"this.src='captcha.php?'+Math.random()\" /> <input class=\"fl yhq_yzm\" id=\"bonus_captcha\" type=\"text\" maxlength=\"6\" /><span class=\"fl yzm_lab\">看不清？<a style=\"cursor:pointer;\" onClick=\"$('#captcha1').click();\" class=\"blue\">换一张</a></span></li> 
	<li class=\"yhq_select\" id=\"use_quan\"><a onClick=\"addBonus($('#bonus_sn').val());\" class=\"cbtn use_btn\" >使用</a></li> 
	<li><span class=\"yhq_lab\"><a class=\"blue yhq_js_login\" style=\"padding-left:10px;\">使用已有优惠券>></a></span></li> 
	<li id=\"yhq_tip_2\"></li> 
	</ul>
	<div class=\"clear\"></div> 
	</dt>";
	...
	$result['content']['total_area']=" <li id=\"total_price\"><span>花费积分：0</span>应付商品金额：<font>¥455.00</font></li> <li id=\"total_discount\" style=\"display:none;\">兑换券折扣：<b>-¥0.00</b></li> <li id=\"total_bonus\" style=\"display:none;\">优惠券折扣：<b>-¥0.00</b></li> <li id=\"total_discount\" style=\"display:none;\">折扣：<b>-¥0.00</b></li> <li id=\"total_amount\" style=\"padding-top: 10px; border-top: 1px solid rgb(234, 234, 234); margin-top: 6px;display:none;\">应付商品金额：<font>¥455.00</font></li> <input id=\"totalprice\" type=\"hidden\" value=\"455.00\"> <input id=\"totalhgintegral\" type=\"hidden\" value=\"0\"> <input id=\"totalbonus\" type=\"hidden\" value=\"0.00\"> <input id=\"totaldiscount\" type=\"hidden\" value=\"0.00\"> <input id=\"totalticket\" type=\"hidden\" value=\"0.00\"> <input id=\"totalamount\" type=\"hidden\" value=\"455.00\"> ";
	
	$result['content']['shipping_area']['top']='';
	$result['content']['shipping_area']['down']='';
	
	$result['content']['discount_area']='';
	
	$result['content']['bonus_area']='';
	
	$result['content']['zengpin_area']='';
	
	$result['content']['favor_out_cart']='';
	$result['content']['youhui_show']=2;
	
	
	$result['content']['recalculate']=1;
