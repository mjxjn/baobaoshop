...
$_LANG['cart_info_top'] = '%d';
$_LANG['cart_info_activity'] = '您的购物金额：%s（以添加到购物车的实时商品金额为准）';
...
$_LANG['use_bonus'] = '使用优惠卷';
$_LANG['use_bonus_kill'] = '使用线下优惠卷';
$_LANG['invoice'] = '开发票';
...
$_LANG['eg_error_number2'] = '对不起，该商品库存不足，现在不能兑换！/ 请选择商品属性后，再次兑换';
