...
$_LANG['reg_date'] = '注册日期';
$_LANG['button_remove'] = '删除宝宝';
$_LANG['users_edit'] = '编辑宝宝账号';
$_LANG['goto_list'] = '返回宝宝列表';
$_LANG['username_empty'] = '宝宝昵称不能为空！';
...
$_LANG['edit_user_failed'] = '修改宝宝资料失败。';
$_LANG['invalid_email'] = '输入了非法的邮件地址。';
$_LANG['update_success'] = '编辑宝宝信息已经成功。';
$_LANG['still_accounts'] = '该会员有余额或欠款\n';
$_LANG['remove_confirm'] = '您确定要删除该宝宝账号吗？';
$_LANG['list_still_accounts'] = '选中的宝宝账户中仍有余额或欠款\n';
$_LANG['list_remove_confirm'] = '您确定要删除所有选中的宝宝账号吗？';
$_LANG['remove_order_confirm'] = '该宝宝账号已经有订单存在，删除该会员账号的同时将清除订单数据。<br />您确定要删除吗？';
$_LANG['remove_order'] = '是，我确定要删除宝宝账号及其订单数据';
$_LANG['remove_cancel'] = '不，我不想删除该宝宝账号了。';
$_LANG['remove_success'] = '宝宝账号 %s 已经删除成功。';
$_LANG['add_success'] = '宝宝账号 %s 已经添加成功。';
$_LANG['batch_remove_success'] = '已经成功删除了 %d 个宝宝账号。';
$_LANG['no_select_user'] = '您现在没有需要删除的宝宝！';
$_LANG['register_points'] = '注册送积分';
$_LANG['username_not_allow'] = '宝宝帐号不允许注册';
$_LANG['username_invalid'] = '无效的宝宝帐号';
