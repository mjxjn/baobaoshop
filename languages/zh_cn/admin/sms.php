...
$_LANG['error_tips'] = '请小心配置短信服务参数，错误可导致短信发送失败！';
$_LANG['enable_old'] = '启用已有账号';

/* 短信特服信息 */
$_LANG['sms_user_name'] = '用户名：';
$_LANG['sms_zh_name'] = '序列号：';
...
$_LANG['register_charge'] = '注册发送短信的内容';
$_LANG['order_charge'] = '订单提交成功发送的短信内容';
$_LANG['confirm_charge'] = '确认订单发送短信的内容';

$_LANG['sendTime_notice']='定时发送时间，格式为 yyyymmddHHiiss, 即为 年年年年月月日日时时分分秒秒,例如:20090504111010 代表2009年5月4日 11时10分10秒,如果不需要定时发送，请为空 (默认)';
...
//$_LANG['error_no'] = '错误标识';
$_LANG['error_no'] = '短信账号配置错误';
$_LANG['error_msg'] = '错误描述';
$_LANG['empty_info'] = '您的短信特服信息为空。';

$_LANG['config_ok'] = '恭喜，短信配送单修改成功！';
$_LANG['config_error'] = '对不起，短信配送单修改失败！';
$_LANG['charge_ok'] = '恭喜，短信格式配置成功！';
$_LANG['charge_error'] = '对不起，短信格式配置失败！';
...
$_LANG['js_languages']['send_empty_error'] = '发送手机号不能为空！';
