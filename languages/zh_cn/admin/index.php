...
$_LANG['await_ship'] = '未发货订单:';//现金支付订单
$_LANG['await_pay'] = '未确认收货订单:';//POS机(刷卡)订单
$_LANG['finished'] = '已成交订单数:';
$_LANG['new_booking'] = '新缺货登记:';
$_LANG['new_reimburse'] = '退款申请:';

$_LANG['today_order']='今日统计信息';
$_LANG['today_pay']='今日订单总数';
$_LANG['today_confirmation']='今日已确认订单数量';
$_LANG['today_cancel']='今日取消订单数量';
$_LANG['today_unconfirmation']='今日未确认订单数量';
$_LANG['today_money']='今日销售金额';
$_LANG['today_member']='今日注册会员数量';
$_LANG['today_vm']='今日平均客单价';

$_LANG['goods_stat'] = '实体商品统计信息';
$_LANG['virtual_card_stat'] = '虚拟卡商品统计';
$_LANG['goods_count'] = '上架商品总数:';
$_LANG['sales_count'] = '促销商品数:';
$_LANG['new_goods'] = '新品推荐数:';
$_LANG['recommed_goods'] = '上刊商品数:';
$_LANG['hot_goods'] = '热销商品数:';
$_LANG['warn_goods'] = '上架商品库存警告数:';
