...
$_LANG['user_bonus_info'] = ' %d 个 &nbsp;价值 :%s';
...
$_LANG['agreement'] = "我已看过并接受《<a href=\"agreement.html\" style=\"color:#ED771C\" target=\"_blank\">婴格服务协议</a>》";
...
$_LANG['passport_js']['tel_empty'] = '电话号码不能为空。';
$_LANG['passport_js']['tel_shorter'] = '请您填写真实的手机号码';
...
$_LANG['passport_js']['code_empty'] = '验证码不能为空。';
...
/*纽瑞滋*/
$_LANG['niuruizi_success']='恭喜您，全部答对了，获得一张30元代金券，点击查看！';
$_LANG['niuruizi_error']='很抱歉，没有全部答对，再接再厉，再来一次！';
$_LANG['niuruizi_over']='很抱歉，您已经参加过了，不要贪心哦！';
$_LANG['niuruizi_msg']='很抱歉，本次活动是回馈老客户答谢活动，所以必须在网站上有过至少一次购物记录哦~';
$_LANG['niuruizi_limit']='很抱歉，今天的100张券已经发放完毕了，明天09:00再来吧^_^';
$_LANG['niuruizi_start']='活动还没开始，敬请期待哦~';
$_LANG['niuruizi_daystart']='活动还未开始哦，每天活动开始时间：09:00！';
?>