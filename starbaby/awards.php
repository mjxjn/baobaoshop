...
$smarty->assign('page_title',      '奖项设置_明星宝宝秀_婴格母婴商城-云南最大的母婴一站式购物网站,妈妈们的放心选择,云南母婴第一品牌!');    // 页面标题
$smarty->assign('awards',     get_baby_awards());
$smarty->assign('helps',            get_shop_help());       // 网店帮助
$smarty->display('starbaby/awards.htm');


function get_baby_awards(){
