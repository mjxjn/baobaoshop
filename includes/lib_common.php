...
function build_uri($app, $params, $append = '', $page = 0, $keywords = '', $size = 0)
{
    ...
    switch ($app)
    {
		...
		case 'top10':
            ...
            {
                $uri = $rewrite ? 'top10-' . $cid : 'top10.php?id=' . $cid;
            }
        ...
        case 'exchange':
            ...
            case 'integral_goods':
            	...
            	{
            		$uri = 'integral_goods.php?act=goods&cat_id=' . $cid;
            		if (isset($price_min))
            		{
            			$uri .= '&amp;integral_min=' . $price_min;
            		}
            	...
            	case 'integral_bonus':
            		...
            		{
            			$uri = 'integral_goods.php?act=coupon&cat_id=' . $cid;
            			if (isset($price_min))
            			{
            				$uri .= '&amp;integral_min=' . $price_min;
            			}
...
$str = str_replace("exe", "", $str); // 把 '_'过滤掉 
$str = str_replace("http://", "", $str); // 把 '_'过滤掉 
