...
//        }
        ...
        if(empty($type))
        {
            $button = '<div style="text-align:center" class="user_pay"><input type="button" class="onlinebuy_btn" onclick="window.open(\'https://www.alipay.com/cooperate/gateway.do?'.$param. '&sign='.md5($sign).'&sign_type=MD5\')" value="" /></div>';
        }elseif($type=='order_list'){
        	$button = '<a href="https://www.alipay.com/cooperate/gateway.do?'.$param. '&sign='.md5($sign).'&sign_type=MD5" target="_blank">付款</a>';
        }
        return $button;
    }
